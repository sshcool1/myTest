...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		NSConfig nsconfig = ConfigBuilder.create(options.getString("config", "./resource/config/board-config.xml")).build();
		...
		final BoardServer server = BoardServer.create(nsconfig).start();
